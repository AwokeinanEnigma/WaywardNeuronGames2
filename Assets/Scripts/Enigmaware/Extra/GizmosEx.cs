...
{
    public static void DrawArrow(Vector3 start, Vector3 direction, float size = 0.2f, bool arrowsOnly = false,
        string label = null)
    {
        DrawArrow(start, direction, Color.white, size, arrowsOnly, label);
    }

    public static void DrawArrow(Vector3 start, Vector3 direction, Color color, float size = 0.2f,
        bool arrowsOnly = false, string label = null)
    {
